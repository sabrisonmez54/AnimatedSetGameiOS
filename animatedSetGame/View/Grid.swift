...
//  Diamond
//
//  Created by Sabri Sönmez on 10/28/19.
...
struct Grid {
    ...
    var bounds: CGRect { didSet { calculateGrid() } }
    var numberOfFrames: Int  { didSet { calculateGrid() } }
    ...
    var bestGridDimensions: GridDimensions?
